...
set_property -dict { PACKAGE_PIN M20   IOSTANDARD LVCMOS33 } [get_ports { sys_rst_n }]; #IO_L7N_T1_AD2N_35 Sch=sw[0]
...
set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports { led_out }]; #IO_0_35 Sch=led5_b
...
#set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33 } [get_ports { error_led }]; #IO_L6N_T0_VREF_34 Sch=led[0]
...
set_property -dict { PACKAGE_PIN Y18   IOSTANDARD LVCMOS33 } [get_ports { dme_rx_pin }]; #IO_L17P_T2_34 Sch=ja_p[1]
set_property -dict { PACKAGE_PIN Y19   IOSTANDARD LVCMOS33 } [get_ports { jam_pin }]; #IO_L17N_T2_34 Sch=ja_n[1]
